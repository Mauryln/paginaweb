      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 max-w-5xl mx-auto mb-16">
            <div className="rounded-2xl border border-[#00ffae]/30 bg-[#221a4d] p-10 flex flex-col items-center text-center hover:shadow-lg transition-all hover-lift animate-slide-up">
              <Laptop2 className="w-14 h-14 text-[#00ffae] mb-4 hover-glow" />
            ...
            <div className="rounded-2xl border border-[#00ffae]/30 bg-[#221a4d] p-10 flex flex-col items-center text-center hover:shadow-lg transition-all hover-lift animate-slide-up" style={{ animationDelay: '0.1s' }}>
              <GraduationCap className="w-14 h-14 text-[#00ffae] mb-4 hover-glow" />
            ...
            <div className="rounded-2xl border border-[#00ffae]/30 bg-[#221a4d] p-10 flex flex-col items-center text-center hover:shadow-lg transition-all hover-lift animate-slide-up" style={{ animationDelay: '0.2s' }}>
              <UserCheck className="w-14 h-14 text-[#00ffae] mb-4 hover-glow" />
            ...
            <div className="rounded-2xl border border-[#00ffae]/30 bg-[#221a4d] p-10 flex flex-col items-center text-center hover:shadow-lg transition-all hover-lift animate-slide-up" style={{ animationDelay: '0.3s' }}>
              <Star className="w-14 h-14 text-[#00ffae] mb-4 hover-glow" />
            ...
            <div className="rounded-2xl border border-[#00ffae]/30 bg-[#221a4d] p-10 flex flex-col items-center text-center hover:shadow-lg transition-all hover-lift animate-slide-up" style={{ animationDelay: '0.4s' }}>
              <ShieldCheck className="w-14 h-14 text-[#00ffae] mb-4 hover-glow" />
            ...
            <div className="rounded-2xl border border-[#00ffae]/30 bg-[#221a4d] p-10 flex flex-col items-center text-center hover:shadow-lg transition-all hover-lift animate-slide-up" style={{ animationDelay: '0.5s' }}>
              <Users className="w-14 h-14 text-[#00ffae] mb-4 hover-glow" />
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6 mt-8 animate-fade-in">
            ...
            <Button 
              size="lg" 
              variant="outline" 
              className="border-[#00ffae] text-[#00ffae] hover:bg-[#00ffae]/10 hover-lift" 
