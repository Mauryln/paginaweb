...
function ServicioCard({ icon, title }: { icon: string; title: string }) {
  ...
  return (
    <div className="bg-gray-100 rounded-2xl shadow p-8 flex flex-col items-center text-center hover:shadow-lg transition-all hover-scale">
...
function CursoDetalleModal({ open, onClose, curso }: { open: boolean; onClose: () => void; curso: any }) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60">
      <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full p-8 relative text-gray-900 animate-fade-in">
        <button onClick={onClose} className="absolute top-4 right-4 text-blue-600 text-2xl font-bold">×</button>
        <div className="flex flex-col md:flex-row gap-6">
          <div className="flex-shrink-0 w-full md:w-56 h-40 md:h-56 relative rounded-xl overflow-hidden border-2 border-blue-600">
          ...
          <div className="flex-1 flex flex-col">
            ...
            <div className="mb-3 text-gray-900/70">{curso.descLong || curso.desc}</div>
            <div className="flex items-center gap-4 mt-auto">
              <span className="font-semibold text-blue-600 text-xl">{curso.price}</span>
        ...
        <div className="mt-6">
          <div className="flex gap-6 border-b mb-4">
            <button className="pb-2 border-b-2 border-blue-600 font-semibold">Descripción</button>
            <button className="pb-2 text-gray-900/50">Contenido</button>
            <button className="pb-2 text-gray-900/50">Instructor</button>
            <button className="pb-2 text-gray-900/50">Opiniones</button>
          </div>
      ...
      <section className="relative overflow-hidden pt-12 pb-24 md:pt-24 md:pb-32">
        <div className="container mx-auto flex flex-col md:flex-row items-center justify-between px-4 gap-8">
          ...
          <div className="flex-1 flex justify-center md:justify-end w-full max-w-lg relative animate-slide-up">
            <div className="w-[840px] h-[420px] rounded-3xl overflow-hidden shadow-2xl border-4 border-blue-600 bg-white/10 hover-scale">
              <Image
                src="/banner1.jpg"
                alt="Hero"
                width={420}
      ...
      <section className="bg-gray-900 py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="rounded-2xl border border-blue-600/30 bg-gray-800 p-10 flex flex-col items-center text-center hover:shadow-lg transition-all">
